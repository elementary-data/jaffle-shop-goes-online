...
setup(
    name="jaffle-shop-goes-online",
    description="Demo environment for Elementary.",
    version="0.1.0",
    ...
    url="https://github.com/elementary-data/jaffle-shop-goes-online",
