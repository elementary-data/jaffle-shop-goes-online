...
def generate_customers_data():
    ...
    for customer_id in range(len(training_customers) + 1, len(training_customers) + 201):
...
def generate_orders_data():
    ...
    last_order_date = max([datetime.strptime(row[2], "%Y-%m-%d") for row in training_orders])
